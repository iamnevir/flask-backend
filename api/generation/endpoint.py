...
@generation.route('/bing_gen', methods=['POST'])
def bing_gen():
    try:
        data = request.json
...
@generation.route('/generate_imagine', methods=['POST'])
...
@generation.route('/img_gen', methods=['POST'])
def img_gen():
    try:
        data = request.json
        prompt = data.get('prompt')
...
@generation.route('/rm_bg', methods=['POST'])
def rm_bg():
    try:
        data = request.json
        url = data.get('url')
...
@generation.route('/imagine_upscale', methods=['POST'])
def imagine_upscale():
    try:
        data = request.json
        url = data.get('url')
...
@generation.route('/generate_image_with_image', methods=['POST'])
...
@generation.route('/edit_image', methods=['POST'])
def edit_image():
    try:
        data = request.json
        image_url = data.get('image_url')
